 ...
 const pads = [
  {
    ...
    sound: new Audio("https://github.com/Johnsjohnj/Simon-Says-johnsjohnj/blob/main/assets/simon-says-sound-1.mp3?raw=true")
  ...
  sound: new Audio("https://github.com/Johnsjohnj/Simon-Says-johnsjohnj/blob/main/assets/simon-says-sound-3.mp3?raw=true"),
},

{color: "yellow",
selector: document.querySelector(".js-pad-yellow"),
sound: new Audio("https://github.com/Johnsjohnj/Simon-Says-johnsjohnj/blob/main/assets/simon-says-sound-4.mp3?raw=true"),
},
...
function checkRound() {
  if (playerSequence.length === maxRoundCount) {
    ...
    roundCount++;
    playerSequence = [];
    statusSpan.innerHTML = "Keep Going!";
...
function resetGame(text) {
 ...
 roundCount=[];
  ...
  alert(text);
   ...
   statusSpan.classList.add(".js-status");
 padContainer.classList.add("unclickable");
}
